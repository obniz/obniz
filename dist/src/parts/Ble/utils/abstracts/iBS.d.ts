...
declare type PresetConfigName = 'battery' | 'button' | 'moving' | 'event' | 'proximity' | 'pir' | 'input_trigger' | 'fall' | 'acceleration' | 'temperature' | 'humidity' | 'voltage' | 'current' | 'flood' | 'triggered' | 'triggered_count' | 'count' | 'user';
