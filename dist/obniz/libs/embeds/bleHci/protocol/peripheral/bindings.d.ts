...
export = BlenoBindings;
declare const BlenoBindings_base: typeof import("events").EventEmitter;
declare class BlenoBindings extends BlenoBindings_base {
    ...
    addListener(event: string | symbol, listener: (...args: any[]) => void): BlenoBindings;
    on(event: string | symbol, listener: (...args: any[]) => void): BlenoBindings;
    once(event: string | symbol, listener: (...args: any[]) => void): BlenoBindings;
    prependListener(event: string | symbol, listener: (...args: any[]) => void): BlenoBindings;
    prependOnceListener(event: string | symbol, listener: (...args: any[]) => void): BlenoBindings;
    removeListener(event: string | symbol, listener: (...args: any[]) => void): BlenoBindings;
    off(event: string | symbol, listener: (...args: any[]) => void): BlenoBindings;
    removeAllListeners(event?: string | symbol | undefined): BlenoBindings;
    setMaxListeners(n: number): BlenoBindings;
}
