...
class WSCommand_PWM extends WSCommand {
  ...
  parseFromJson(json) {
    for (var i = 0; i < this.ModuleNum; i++) {
      ...
      let schemaData = [{ uri: "/request/pwm/io", onValid: this.io }, { uri: "/request/pwm/freq", onValid: this.freq }, { uri: "/request/pwm/pulse", onValid: this.pulse }, { uri: "/request/pwm/duty", onValid: this.duty }, { uri: "/request/pwm/modulate", onValid: this.amModulate }, { uri: "/request/pwm/null", onValid: this.deinit }];
