...
export default class iBS02IR_Ranger extends BaseiBS<iBS02IR_Data> {
  public static readonly PartsName = 'iBS02IR_Ranger';
  ...
  protected readonly staticClass = iBS02IR_Ranger;
}
