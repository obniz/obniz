...
export interface  ShizukuLEDOptions {}

export interface  ShizukuLED_Data {
  row_number: number;
  temperature: number;
...
export default class ShizukuLED implements ObnizPartsInterface {
  ...
  public async findWait(): Promise<bleRemotePeripheral | null> {
  ...
  public async getLatestData(): Promise<ShizukuLED_Data> {
