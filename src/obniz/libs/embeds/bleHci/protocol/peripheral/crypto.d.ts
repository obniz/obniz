// Type definitions for bleHciProtocolPeripheralCrypto
...
declare module "bleHciProtocolPeripheralCrypto" {

  export default bleHciProtocolPeripheralCrypto;    // es6 style module export
}
