...
import IBS02IR from '../parts/Ble/iBS02IR';
import { iBS02IROptions } from '../parts/Ble/iBS02IR/base';
import IBS02IR_Ingics from '../parts/Ble/iBS02IR/ingics';
import IBS02IR_Ranger from '../parts/Ble/iBS02IR/ranger';
...
export interface PartsList {
  ...
  iBS02IR_Ranger: PartsInterface<
    IBS02IR_Ranger,
    iBS02IROptions,
    typeof IBS02IR_Ranger
  >;
  iBS02IR_Ingics: PartsInterface<
    IBS02IR_Ingics,
    iBS02IROptions,
    typeof IBS02IR_Ingics
  >;
