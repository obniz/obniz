...
describe("uart.log", function () {
    ...
    it("request test no.0",  function () {
        ...
        let expecteBinaryStrings = ["04 00 0d 00 00 01 00 00 25 80 01 07 00 00 00 00"];
    ...
    it("request test no.2",  function () {
        ...
        let expecteBinaryStrings = ["04 00 0d 01 00 01 00 01 C2 00 01 08 00 00 00 00"];
    ...
    it("request test no.5",  function () {
        ...
        let expecteBinaryStrings = ["04 00 0d 00 02 03 00 01 C2 00 01 08 00 00 00 00"];
    ...
    it("response test no.6",  function () {
        ...
        let expectJson  = [{"uart1":{"data":[0,105,97,115,100,102,97,115,100,102]}}];
    ...
    it("request test no.7",  function () {
        let requestJson  = [{"uart0":{"tx":0,"rx":1,"baud":115200,"stop":1.5,"bits":7,"parity":"odd","flowcontrol":"rts","rts":10}}];
        let expecteBinaryStrings = ["04 00 0d 00 00 01 00 01 c2 00 02 07 03 02 0a 00"];
    ...
    it("request test no.8",  function () {
        let requestJson  = [{"uart1":{"tx":2,"rx":3,"baud":115200,"stop":1.5,"bits":7,"parity":"odd","flowcontrol":"rts","rts":11}}];
        let expecteBinaryStrings = ["04 00 0d 01 02 03 00 01 c2 00 02 07 03 02 0b 00"];
