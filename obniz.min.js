var Obniz=function(e){var t={};function r(i){if(t[i])return t[i].exports;var s=t[i]={i:i,l:!1,exports:{}};return e[i].call(s.exports,s,s.exports,r),s.l=!0,s.exports}return r.m=e,r.c=t,r.d=function(e,t,i){r.o(e,t)||Object.defineProperty(e,t,{configurable:!1,enumerable:!0,get:i})},r.r=function(e){Object.defineProperty(e,"__esModule",{value:!0})},r.n=function(e){var t=e&&e.__esModule?function(){return e.default}:function(){return e};return r.d(t,"a",t),t},r.o=function(e,t){return Object.prototype.hasOwnProperty.call(e,t)},r.p="",r(r.s=0)}([function(e,t,r){(function(t){const i=r(243),s=r(228),n=r(227),a=r(226),o=r(225),d=r(224),c=r(223),h=r(222),u=r(221),l=r(220),p=r(219),m=r(218),f=r(2),y=r(217);let g="undefined"==typeof window;class v{constructor(e,t){if(this.isNode=g,this.apiversion=1,this.id=e,this.socket=null,this.debugprint=!1,this.debugs=[],this.pongObservers=[],this.bufferdAmoundWarnBytes=1e5,this.init(),t||(t={}),this.server_obnizio=t.obniz_server||"wss://obniz.io",this._access_token=t.access_token,this.debugDomId=t.debug_dom_id||"obniz-debug",this.auto_connect="boolean"!=typeof t.auto_connect||t.auto_connect,!1!==t.binary){this.wscommand=this.constructor.WSCommand;let e=this.constructor.WSCommand.CommandClasses;this.wscommands=[];for(let t in e)this.wscommands.push(new e[t])}if(!1===this.isNode&&this.showOffLine(),this.isValidObnizId(this.id))this.auto_connect&&this.wsconnect();else if(g)this.error("invalid obniz id");else{let e=function(e){let t=e+"=",r=document.cookie.split(";");for(let e=0;e<r.length;e++){let i=r[e];for(;" "===i.charAt(0);)i=i.substring(1,i.length);if(0===i.indexOf(t))return i.substring(t.length,i.length)}return null}("obniz-last-used")||"";this.prompt(e,function(e){this.id=e,this.showOffLine(),this.wsconnect()}.bind(this))}}static get version(){return r(55).version}static get WSCommand(){return y}isValidObnizId(e){if("string"!=typeof e||e.length<8)return null;e=e.replace("-","");let t=parseInt(e);return isNaN(t)&&(t=null),null!=t}prompt(e,t){var r=prompt("Please enter obniz id",e);r&&t(r)}wsOnOpen(){this.print_debug("ws connected"),"function"==typeof this.onopen&&this.onopen(this)}binary2Json(e){let t=new Uint8Array(e),r=[];for(;;){const e=y.dequeueOne(t);if(!e)break;let s={};for(var i=0;i<this.wscommands.length;i++){const t=this.wscommands[i];if(t.module===e.module){t.notifyFromBinary(s,e.func,e.payload);break}}r.push(s),t=e.next}return r}wsOnMessage(e){let t;if(this.debugprintBinary&&"string"!=typeof e&&this.print_debug(""+new Uint8Array(e).toString()),"string"==typeof e?t=JSON.parse(e):this.wscommands&&(t=this.binary2Json(e)),Array.isArray(t))for(let e in t)this.notifyToModule(t[e])}notifyToModule(e){if(this.print_debug(JSON.stringify(e)),"object"==typeof e.message&&this.onmessage&&this.onmessage(e.message.data,e.message.from),"object"==typeof e.debug){if(e.debug.warning){let t="Warning: "+e.debug.warning.message;this.warning({alert:"warning",message:t})}if(e.debug.error){let t="Error: "+e.debug.error.message;this.error({alert:"error",message:t})}this.ondebug&&this.ondebug(e.debug)}if(e.ws)return void this.handleWSCommand(e.ws);if(e.system)return void this.handleSystemCommand(e.system);let t=["io","uart","spi","i2c","ad"];for(let r=0;r<t.length;r++){let i=-1,s=t[r];for(;void 0!==this[s+""+ ++i];){let t=e[s+""+i];void 0!==t&&this[s+""+i].notified(t)}}let r=["switch","ble","measure"];for(let t=0;t<r.length;t++)e[r[t]]&&this[r[t]].notified(e[r[t]]);e.logic_analyzer&&this.logicAnalyzer.notified(e.logic_analyzer)}wsOnClose(e){this.print_debug("closed"),!1===this.isNode&&this.showOffLine(),this.looper&&(this.looper=null),this.clearSocket(this.socket),"function"==typeof this.onclose&&this.onclose(this),this.auto_connect&&setTimeout(function(){this.wsconnect()}.bind(this),1e3)}wsOnError(e){console.error("websocket error.")}wsOnUnexpectedResponse(e,t){let r=1e3;t&&404==t.statusCode?this.print_debug("obniz not online"):(r=5e3,this.print_debug(t.statusCode)),this.clearSocket(this.socket),this.auto_connect&&setTimeout(function(){this.wsconnect()}.bind(this),r)}wsconnect(e){let t=this.server_obnizio;e&&(t=""+e),this.socket&&(this.socket.close(),this.clearSocket(this.socket));let i=t+"/obniz/"+this.id+"/ws/"+this.apiversion;if(this.constructor.version&&(i+="?obnizjs="+this.constructor.version),this._access_token&&(i+="&access_token="+this._access_token),this.wscommand&&(i+="&accept_binary=true"),this.print_debug("connecting to "+i),this.isNode){const e=r(54);this.socket=new e(i),this.socket.on("open",this.wsOnOpen.bind(this)),this.socket.on("message",this.wsOnMessage.bind(this)),this.socket.on("close",this.wsOnClose.bind(this)),this.socket.on("error",this.wsOnError.bind(this)),this.socket.on("unexpected-response",this.wsOnUnexpectedResponse.bind(this))}else this.socket=new WebSocket(i),this.socket.binaryType="arraybuffer",this.socket.onopen=this.wsOnOpen.bind(this),this.socket.onmessage=function(e){this.wsOnMessage(e.data)}.bind(this),this.socket.onclose=this.wsOnClose.bind(this),this.socket.onerror=this.wsOnError.bind(this)}clearSocket(e){if(this._sendQueueTimer&&(delete this._sendQueue,clearTimeout(this._sendQueueTimer),this._sendQueueTimer=null),this.isNode){let t=["open","message","close","error"];for(let r=0;r<t.length;r++)e.removeAllListeners(t[r])}else e.onopen=null,e.onmessage=null,e.onclose=null,e.onerror=null;this.socket=null}connect(){this.wsconnect()}close(){this.socket&&(this._drainQueued(),this.socket.close(1e3,"close"),this.clearSocket(this.socket))}wired(e){let t=new _[e];if(!t)throw new Error("No such a parts ["+e+"] found");let r=Array.from(arguments);if(r.shift(),r.unshift(this),t.keys){if(t.requiredKeys){let i=f._requiredKeys(r[1],t.requiredKeys);if(i)throw new Error(e+" wired param '"+i+"' required, but not found ")}t.params=f._keyFilter(r[1],t.keys)}if(t.obniz=this,t.wired.apply(t,r),t.keys||t.ioKeys){let i=t.ioKeys||t.keys,s=t.displayName||e,n={};for(let e in i){let s=i[e],a=r[1][s];this.isValidIO(a)&&(t.displayIoNames&&t.displayIoNames[s]&&(s=t.displayIoNames[s]),n[a]=s)}this.display.setPinNames(s,n)}return t}print_debug(e){this.debugprint&&console.log("Obniz: "+e)}send(e){if(!e||"object"!=typeof e)return void console.log("obnizjs. didnt send ",e);if(Array.isArray(e)){for(let t=0;t<e.length;t++)this.send(e[t]);return}if(this.sendPool)return void this.sendPool.push(e);let t=JSON.stringify([e]);if(this.wscommand){let e;try{(e=this.wscommand.compress(this.wscommands,JSON.parse(t)[0]))&&(t=e)}catch(e){throw this.error("------ errored json -------"),this.error(t),e}}this.debugprint&&(this.print_debug("send: "+("string"==typeof t?t:JSON.stringify(e))),this.debugprintBinary&&"string"!=typeof t&&this.print_debug("send: "+t.toString())),"string"==typeof t?(this._drainQueued(),this.socket.send(t)):this._sendQueue?this._sendQueue.push(t):(this._sendQueue=[t],this._sendQueueTimer=setTimeout(this._drainQueued.bind(this),1))}_drainQueued(){if(!this._sendQueue)return;let e=0;for(let t=0;t<this._sendQueue.length;t++)e+=this._sendQueue[t].length;let t=0,r=new Uint8Array(e);for(let e=0;e<this._sendQueue.length;e++)r.set(this._sendQueue[e],t),t+=this._sendQueue[e].length;this.socket.send(r),delete this._sendQueue,clearTimeout(this._sendQueueTimer),this._sendQueueTimer=null,this.socket.bufferedAmount>this.bufferdAmoundWarnBytes&&this.error("Warning: over "+this.socket.bufferedAmount+" bytes queued")}init(){this.io=new u(this);for(let e=0;e<12;e++)this["io"+e]=new h(this,e);for(let e=0;e<12;e++)this["ad"+e]=new d(this,e);for(let e=0;e<2;e++)this["uart"+e]=new m(this,e);for(let e=0;e<2;e++)this["spi"+e]=new p(this,e);for(let e=0;e<1;e++)this["i2c"+e]=new c(this,e);for(let e=0;e<6;e++)this["pwm"+e]=new l(this,e);this.display=new s(this),this.switch=new n(this),this.logicAnalyzer=new a(this),this.ble=new i(this),this.measure=new o(this),this.util=new f(this)}isValidIO(e){return"number"==typeof e&&e>=0&&e<12}setVccGnd(e,t,r){this.isValidIO(e)&&(r&&this.getIO(e).drive(r),this.getIO(e).output(!0)),this.isValidIO(t)&&(r&&this.getIO(t).drive(r),this.getIO(t).output(!1))}getIO(e){if(!this.isValidIO(e))throw new Error("io "+e+" is not valid io");return this["io"+e]}getAD(e){if(!this.isValidIO(e))throw new Error("ad "+e+" is not valid io");return this["ad"+e]}getFreePwm(){let e=0;for(;;){let t=this["pwm"+e];if(!t)break;if(!t.isUsed())return t.used=!0,t;e++}throw new Error("No More PWM Available. max = "+e)}getFreeI2C(){let e=0;for(;;){let t=this["i2c"+e];if(!t)break;if(!t.isUsed())return t.used=!0,t;e++}throw new Error("No More I2C Available. max = "+e)}getI2CWithConfig(e){if("object"!=typeof e)throw new Error("getI2CWithConfig need config arg");if(e.i2c)return e.i2c;let t=this.getFreeI2C();return t.start(e),t}getFreeSpi(){let e=0;for(;;){let t=this["spi"+e];if(!t)break;if(!t.isUsed())return t.used=!0,t;e++}throw new Error("No More SPI Available. max = "+e)}getSpiWithConfig(e){if("object"!=typeof e)throw new Error("getSpiWithConfig need config arg");if(e.spi)return e.spi;let t=this.getFreeSpi();return t.start(e),t}getFreeUart(){let e=0;for(;;){let t=this["uart"+e];if(!t)break;if(!t.isUsed())return t.used=!0,t;e++}throw new Error("No More uart Available. max = "+e)}addPongObserver(e){e&&this.pongObservers.push(e)}removePongObserver(e){if(this.pongObservers.includes(e)){let t=this.pongObservers.indexOf(e);this.pongObservers.splice(t,1)}}handleSystemCommand(e){if(e.pong)for(let t of this.pongObservers)t(e)}handleWSCommand(e){if(e.ready&&(this.resetOnDisconnect(!0),!1===this.isNode&&this.showOnLine(),this.onconnect)){let e=this.onconnect(this);e instanceof Promise&&e.catch(e=>{console.error(e)})}if(e.redirect){let t=e.redirect;this.print_debug("WS connection changed to "+t),this.close(),this.wsconnect(t)}}message(e,t){let r=[];"string"==typeof e?r.push(e):r=e,this.send({message:{to:r,data:t}})}repeat(e,t){if(this.looper)return void(this.looper=e);this.looper=e;let r=this;t||(t=100),async function e(){"function"==typeof r.looper&&(await r.looper(),setTimeout(e,t))}()}wait(e){return e<0?e=0:e>6e4&&(e=6e4),this.send({system:{wait:e}}),new Promise(t=>setTimeout(t,e))}reset(){this.send({system:{reset:!0}}),this.init()}reboot(){this.send({system:{reboot:!0}}),this.init()}selfCheck(){this.send({system:{self_check:!0}})}keepWorkingAtOffline(e){this.send({system:{keep_working_at_offline:e}})}resetOnDisconnect(e){this.send({ws:{reset_obniz_on_ws_disconnection:e}})}pingWait(e,t){e=e||(new Date).getTime();let r=Math.floor(e/Math.pow(2,32)),i=e-r*Math.pow(2,32);t=t||Math.floor(Math.random()*Math.pow(2,4));let s=[];return s.push(r>>>24&255),s.push(r>>>16&255),s.push(r>>>8&255),s.push(r>>>0&255),s.push(i>>>24&255),s.push(i>>>16&255),s.push(i>>>8&255),s.push(i>>>0&255),s.push(t>>>24&255),s.push(t>>>16&255),s.push(t>>>8&255),s.push(t>>>0&255),this.send({system:{ping:{key:s}}}),new Promise(e=>{let t=r=>{for(let e=0;e<s.length;e++)if(s[e]!==r.pong.key[e])return;this.removePongObserver(t);let i=(r.pong.key[0]<<24>>>0)+(r.pong.key[1]<<16>>>0)+(r.pong.key[2]<<8>>>0)+(r.pong.key[3]<<0>>>0),n=(r.pong.key[4]<<24>>>0)+(r.pong.key[5]<<16>>>0)+(r.pong.key[6]<<8>>>0)+(r.pong.key[7]<<0>>>0),a=i*Math.pow(2,32)+n,o=(new Date).getTime(),d=`ping ${o-a}ms (js --[${r.pong.pingServerTime-a}ms]--\x3e server --[${r.pong.obnizTime-r.pong.pingServerTime}ms]--\x3e obniz --[${r.pong.pongServerTime-r.pong.obnizTime}ms]--\x3e server --[${o-r.pong.pongServerTime}ms]--\x3e js)`;this.print_debug(d),e(d)};this.addPongObserver(t)})}warning(e){if(this.isNode)console.error(e);else{if(e&&"object"==typeof e&&e.alert)return this.showAlertUI(e),void console.log(e.message);b(new Error(e))}}error(e){this.isNode?console.error(e):(e&&"object"==typeof e&&e.alert&&(this.showAlertUI(e),e=e.message),b(new Error(e)),console.error(new Error(e)))}showAlertUI(e){if(this.isNode||!document.getElementById(this.debugDomId))return;let t=`\n    <div style="background-color:${"warning"===e.alert?"#ffee35":"#ff7b34"}">${e.message}</div>`;document.getElementById(this.debugDomId).insertAdjacentHTML("beforeend",t)}getDebugDoms(){if(this.isNode)return;let e=document.querySelector("#loader"),t=document.querySelector("#"+this.debugDomId),r=document.querySelector("#"+this.debugDomId+" #online-status");return t&&!r&&((r=document.createElement("div")).id="online-status",r.style.color="#FFF",r.style.padding="5px",r.style.textAlign="center",t.insertBefore(r,t.firstChild)),{loaderDom:e,debugDom:t,statusDom:r}}showOnLine(){if(this.isNode)return;let e=this.getDebugDoms();e.loaderDom&&(e.loaderDom.style.display="none"),e.statusDom&&(e.statusDom.style.backgroundColor="#449d44",e.statusDom.style.color="#FFF",e.statusDom.innerHTML=this.id?"online : "+this.id:"online")}showOffLine(){if(this.isNode)return;let e=this.getDebugDoms();e.loaderDom&&(e.loaderDom.style.display="block"),e.statusDom&&(e.statusDom.style.backgroundColor="#d9534f",e.statusDom.style.color="#FFF",e.statusDom.innerHTML=this.id?"offline : "+this.id:"offline")}}let _={};if(v._parts=_,v.PartsRegistrate=function(e,t){_[e]=t},v.Parts=function(e){return new _[e]},!g){function b(e){if(!window.parent||!window.parent.logger)throw e;window.parent.logger.onObnizError(e)}window&&window.parent&&window.parent.userAppLoaded&&window.parent.userAppLoaded(window)}e.exports=v,r(5).context=r(10),r(5).context&&r(5).context.setBaseDir&&r(5).context.setBaseDir(t);let w=r(53);for(let e of w.keys())w(e)}).call(this,"/")},function(e,t,r){const i=r(216);let s={};class n{constructor(e){this.delegate=e,this.COMMAND_FUNC_ID_ERROR=255,this.ioNotUsed=255}static get schema(){return i}static get CommandClasses(){return s}static addCommandClass(e,t){s[e]=t}static framed(e,t,r){var i,s=0;if(r&&(s=r.length),s<=63)i=0;else if(s<=16383)i=1;else{if(!(s<=1073741823))throw new Error("too big payload");i=2}var n=0==i?0:1==i?1:3,a=3+n,o=new Uint8Array(a+s),d=0;for(o[d++]=127&e,o[d++]=t,o[d++]=i<<6|s>>8*n;n>0;)n--,o[d++]=s>>8*n;return 0==s?o:(o.set(r,a),o)}static dequeueOne(e){if(!e||0==e.byteLength)return null;if(e.byteLength<3)throw new Error("something wrong. buf less than 3");if(128&e[0])throw new Eror("reserved bit 1");var t=127&e[0],r=e[1],i=e[2]>>6&3,s=0==i?0:1==i?1:3;if(4==i)throw new Eror("invalid length");for(var n=(63&e[2])<<8*s,a=3,o=s;o>0;)o--,n+=e[a]<<8*o,a++;return{module:t,func:r,payload:e.slice(3+s,3+s+n),next:e.slice(3+s+n)}}static compress(e,t){var r=null;function i(e,t,i){var s=n.framed(e,t,i);if(r){var a=new Uint8Array(r.length+s.length);a.set(r,0),a.set(s,r.length),r=a}else r=s}for(let r=0;r<e.length;r++){const s=e[r];s.parsed=i,s.parseFromJson(t)}return r}sendCommand(e,t){this.delegate&&this.delegate.onParsed&&this.delegate.onParsed(this.module,e,t),this.parsed&&this.parsed(this.module,e,t)}parseFromJson(e){}notifyFromBinary(e,t,r){switch(t){case this.COMMAND_FUNC_ID_ERROR:e.debug||(e.debug={});var i={module:this.module,_args:[...r]};3==r.byteLength?(i.err0=r[0],i.err1=r[1],i.function=r[2],i.message=`Error module=${this.module} func=${i.function} err0=${i.err0} returned=${i.err1}`):i.message=`Error module=${this.module} with + ${i._args}`,e.debug.error=i}}envelopWarning(e,t,r){e[t]||(e[t]={}),e[t].warning=r}envelopError(e,t,r){e[t]||(e[t]={}),e[t].error=r}isValidIO(e){return"number"==typeof e&&0<=e&&e<=11}getSchema(e){return i.getSchema(e)}validateCommandSchema(e,t,r,i){let s={valid:0,invalid:0,results:[],invalidButLike:[]};for(let n of e){let e=this.validate(n.uri,t);if(s.results.push(e),e.valid)s.valid++,n.onValid&&n.onValid.bind(this)(this.filter(n.uri,t),i);else{s.invalid++;let t=this.onlyTypeErrorMessage(e,r);t&&s.invalidButLike.push({uri:n.uri,message:t})}}return s}validate(e,t){let r=this.getSchema(e);return i.validateMultiple(t,r)}onlyTypeErrorMessage(e,t){if(e.valid)return!0;if(e.missing&&e.missing.length>0)return!1;let r=[i.errorCodes.ANY_OF_MISSING,i.errorCodes.ONE_OF_MISSING,i.errorCodes.ONE_OF_MULTIPLE,i.errorCodes.NOT_PASSED,i.errorCodes.OBJECT_REQUIRED,i.errorCodes.OBJECT_ADDITIONAL_PROPERTIES,i.errorCodes.CIRCULAR_REFERENCE,i.errorCodes.FORMAT_CUSTOM,i.errorCodes.KEYWORD_CUSTOM,i.errorCodes.UNKNOWN_PROPERTY],s=[];for(let n of e.errors){if(n.code===i.errorCodes.INVALID_TYPE){if("object"===n.params.type||"object"===n.params.expected)return!1}else if(r.includes(n.code))return!1;let e=t+n.dataPath.replace(/\//g,".");s.push(`[${e}]${n.message}`)}return s.join(";")}filter(e,t){let r=this.getSchema(e);return this._filterSchema(r,t)}_filterSchema(e,t){if(e.$ref){let r=i.getSchema(e.$ref);return this._filterSchema(r,t)}if(void 0===t)return e.default;if("string"===e.type||"integer"===e.type||"boolean"===e.type||"number"===e.type||"null"===e.type||"pass_all"===e.filter)return t;if("array"===e.type){let r=[];for(let i in t)r[i]=this._filterSchema(e.items,t[i]);return r}if("object"===e.type){let r={};for(let i in e.properties)r[i]=this._filterSchema(e.properties[i],t[i]);for(let i in e.patternProperties){let s=new RegExp(i);for(let n of Object.keys(t))s.test(n)&&(r[n]=this._filterSchema(e.patternProperties[i],t[n]))}return r}throw Error("unknown json schema type")}get WSCommandNotFoundError(){return a}}class a extends Error{}e.exports=n},function(e,t,r){(function(t){let i="undefined"==typeof window;e.exports=class{constructor(e){this.obniz=e}createCanvasContext(e,t){if(!this.obniz.isNode){var i=document.createElement("canvas");return i.width=e,i.height=t,i.style["-webkit-font-smoothing"]="none",document.getElementsByTagName("body")[0].appendChild(i),i.getContext("2d")}try{const{createCanvas:e}=r(13);return e(this.width,this.height)}catch(e){throw new Error("obniz.js require node-canvas to draw rich contents. see more detail on docs")}}static _keyFilter(e,t){var r={};return"object"!=typeof e?r:r=Object.keys(e).filter(e=>t.includes(e)).reduce((t,r)=>(t[r]=e[r],t),{})}static _requiredKeys(e,t){if("object"!=typeof e)return t[0];for(var r in t)if(!(t[r]in e))return t[r];return null}static dataArray2string(e){var s=null;try{if(i){const i=r(237).StringDecoder;i&&(s=new i("utf8").write(t.from(e)))}else TextDecoder&&(s=new TextDecoder("utf-8").decode(new Uint8Array(e)))}catch(e){}return s}static string2dataArray(e){if(i)return[...t(e)];if(TextEncoder){const t=new TextEncoder("utf-8").encode(e);for(var r=new Array(t.length),s=0;s<t.length;s++)r[s]=t[s];return r}return null}}}).call(this,r(4).Buffer)},function(e,t){e.exports=class{constructor(){this.keys=["vcc","gnd","signal"],this.requiredKeys=["signal"],this.drive="5v"}wired(e){this.obniz=e,e.setVccGnd(this.params.vcc,this.params.gnd,this.drive),this.ad=e.getAD(this.params.signal),this.ad.start(function(e){this.temp=this.calc(e),this.onchange(this.temp)}.bind(this))}onchange(e){}calc(e){return 0}}},function(e,t,r){"use strict";(function(e){
/*!
