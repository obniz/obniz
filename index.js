...
Obniz.prototype.wsconnect = function(desired_server) {
  ...
  if (isNode) {
    ...
    this.socket = new WebSocket("ws://"+window.location.host+"/obniz/"+this.id+"/ws");
...
// Obniz.prototype.connect = function(module) {
//   var args = Array.from(arguments);
//   args.shift();
//   args.unshift(this);
//   module.wire.apply(module, args);
// }
...
// test
// var base64 = bufferToBase64([1,100,255]);
// console.log(base64);
